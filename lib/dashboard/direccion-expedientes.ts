...
export function mapDirectExpenseToExpedienteOrder(expense: DirectExpenseDto): PurchaseOrderDto {
  return {
    ...
    invoiceFirstCommitmentId: null,
    processKind: "a",
    expedienteId: null,
    expedienteFolio: null,
    expedienteName: null,
    ...
    fxRate: null,
    fxRateDate: null,
    totalAmountMxn: expense.currency === "MXN" ? expense.estimatedAmount : null,
    fxNote: "",
...
export function mapInvoiceFirstToExpedienteOrder(c: InvoiceFirstCommitmentDto): PurchaseOrderDto {
  return {
    ...
    fxRate: null,
    fxRateDate: null,
    totalAmountMxn: c.currency === "MXN" ? c.displayTotal : null,
    fxNote: "",
